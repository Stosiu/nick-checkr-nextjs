...
export const services: ServiceDefinition[] = [
  ...
  { name: 'Mastodon', url: 'https://mastodon.social/@{}', apiUrl: 'https://mastodon.social/api/v1/accounts/lookup?acct={}', category: 'Social Media', checkMethod: CheckMethod.JsonApi, jsonPath: 'id', testTakenNick: 'Gargron', testAvailableNick: 'zqvx8841mkw' },
  ...
  { name: 'Tumblr', url: 'https://{}.tumblr.com', category: 'Social Media', checkMethod: CheckMethod.Unverifiable, unverifiableReason: UnverifiableReason.BotProtected, testTakenNick: 'alex', testAvailableNick: 'alex3232e2e2e' },
  ...
  { name: 'Threads', url: 'https://www.threads.com/@{}', category: 'Social Media', checkMethod: CheckMethod.Unverifiable, unverifiableReason: UnverifiableReason.ClientRendered, testTakenNick: 'alex', testAvailableNick: 'alex3232e2e2e' },
  ...
  { name: 'SourceForge', url: 'https://sourceforge.net/u/{}', category: 'Developer', checkMethod: CheckMethod.Unverifiable, unverifiableReason: UnverifiableReason.BotProtected, testTakenNick: 'alex', testAvailableNick: 'alex3232e2e2e' },
  { name: 'Docker Hub', url: 'https://hub.docker.com/u/{}', category: 'Developer', checkMethod: CheckMethod.Unverifiable, unverifiableReason: UnverifiableReason.BotProtected, testTakenNick: 'alex', testAvailableNick: 'alex3232e2e2e' },
  ...
  { name: 'Designspiration', url: 'https://www.designspiration.com/{}/', category: 'Creative & Design', checkMethod: CheckMethod.Unverifiable, unverifiableReason: UnverifiableReason.BotProtected, testTakenNick: 'alex', testAvailableNick: 'alex3232e2e2e' },
  ...
  { name: 'Chess.com', url: 'https://www.chess.com/member/{}', category: 'Gaming', checkMethod: CheckMethod.Unverifiable, unverifiableReason: UnverifiableReason.BotProtected, testTakenNick: 'alex', testAvailableNick: 'alex3232e2e2e' },
  ...
  { name: 'IFTTT', url: 'https://www.ifttt.com/p/{}', category: 'Community', checkMethod: CheckMethod.Unverifiable, unverifiableReason: UnverifiableReason.BotProtected, testTakenNick: 'alex', testAvailableNick: 'alex3232e2e2e' },
  ...
  // Messaging
  { name: 'Slack', url: 'https://{}.slack.com', category: 'Messaging', checkMethod: CheckMethod.Unverifiable, unverifiableReason: UnverifiableReason.BotProtected, testTakenNick: 'alex', testAvailableNick: 'alex3232e2e2e' },
  { name: 'Kik', url: 'https://ws2.kik.com/user/{}', category: 'Messaging', checkMethod: CheckMethod.Standard, testAvailableNick: 'alex3232e2e2e' },
  { name: 'Telegram', url: 'https://t.me/{}', category: 'Messaging', checkMethod: CheckMethod.PresenceMatch, presenceMatch: 'tgme_page_title', testTakenNick: 'durov', testAvailableNick: 'zqvx8841mkw' },
  ...
  { name: 'Codeberg', url: 'https://codeberg.org/{}', category: 'Developer', checkMethod: CheckMethod.Unverifiable, unverifiableReason: UnverifiableReason.BotProtected, testTakenNick: 'alex', testAvailableNick: 'alex3232e2e2e' },
  ...
  // Additional Developer
  { name: 'CodeSandbox', url: 'https://codesandbox.io/u/{}', category: 'Developer', checkMethod: CheckMethod.Unverifiable, unverifiableReason: UnverifiableReason.BotProtected, testTakenNick: 'alex', testAvailableNick: 'alex3232e2e2e' },
  ...
  { name: 'OpenHub', url: 'https://openhub.net/accounts/{}', category: 'Developer', checkMethod: CheckMethod.Unverifiable, unverifiableReason: UnverifiableReason.BotProtected, testTakenNick: 'alex', testAvailableNick: 'alex3232e2e2e' },
  ...
  { name: 'Grouvee', url: 'https://www.grouvee.com/user/{}/', category: 'Gaming', checkMethod: CheckMethod.Unverifiable, unverifiableReason: UnverifiableReason.BotProtected, testTakenNick: 'alex', testAvailableNick: 'alex3232e2e2e' },
  ...
  { name: 'Artfol', url: 'https://artfol.app/{}', category: 'Creative & Design', checkMethod: CheckMethod.Unverifiable, unverifiableReason: UnverifiableReason.BotProtected, testTakenNick: 'alex', testAvailableNick: 'alex3232e2e2e' },
  ...
  { name: 'Heroku', url: 'https://{}.herokuapp.com', category: 'Developer', checkMethod: CheckMethod.Standard, testAvailableNick: 'alex3232e2e2e' },
  ...
  { name: 'Savee', url: 'https://savee.com/{}/', category: 'Professional', checkMethod: CheckMethod.Unverifiable, unverifiableReason: UnverifiableReason.ClientRendered, testTakenNick: 'alex', testAvailableNick: 'alex3232e2e2e' },
  ...
  // More Finance & Crypto
  { name: 'LooksRare', url: 'https://looksrare.org/accounts/{}', category: 'Finance & Crypto', checkMethod: CheckMethod.Unverifiable, unverifiableReason: UnverifiableReason.BotProtected, testTakenNick: 'alex', testAvailableNick: 'alex3232e2e2e' },
  ...
  { name: 'Cults3D', url: 'https://www.cults3d.com/en/users/{}/3d-models', category: 'Creative & Design', checkMethod: CheckMethod.Unverifiable, unverifiableReason: UnverifiableReason.BotProtected, testTakenNick: 'alex', testAvailableNick: 'alex3232e2e2e' },
  { name: 'GrabCAD', url: 'https://grabcad.com/{}', category: 'Creative & Design', checkMethod: CheckMethod.Unverifiable, unverifiableReason: UnverifiableReason.BotProtected, testTakenNick: 'alex', testAvailableNick: 'alex3232e2e2e' },
  ...
  { name: '.shop', url: 'https://rdap.gmoregistry.net/rdap/domain/{}.shop', category: 'Domain Names', checkMethod: CheckMethod.Unverifiable, unverifiableReason: UnverifiableReason.RateLimited, testTakenNick: 'google', testAvailableNick: 'alex3232e2e2e' },
  ...
  { name: '.ar', url: 'https://rdap.nic.ar/domain/{}.ar', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.art', url: 'https://rdap.centralnic.com/art/domain/{}.art', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.as', url: 'https://rdap.nic.as/domain/{}.as', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.attorney', url: 'https://rdap.identitydigital.services/rdap/domain/{}.attorney', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.audio', url: 'https://rdap.centralnic.com/audio/domain/{}.audio', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.band', url: 'https://rdap.identitydigital.services/rdap/domain/{}.band', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.bar', url: 'https://rdap.registry.bar/rdap/domain/{}.bar', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.best', url: 'https://rdap.centralnic.com/best/domain/{}.best', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.boutique', url: 'https://rdap.identitydigital.services/rdap/domain/{}.boutique', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.buzz', url: 'https://rdap.nic.buzz/domain/{}.buzz', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.cafe', url: 'https://rdap.identitydigital.services/rdap/domain/{}.cafe', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.care', url: 'https://rdap.identitydigital.services/rdap/domain/{}.care', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.chat', url: 'https://rdap.identitydigital.services/rdap/domain/{}.chat', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.clinic', url: 'https://rdap.identitydigital.services/rdap/domain/{}.clinic', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.co.in', url: 'https://rdap.nixiregistry.in/rdap/domain/{}.co.in', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.co.uk', url: 'https://rdap.nominet.uk/uk/domain/{}.co.uk', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.coach', url: 'https://rdap.identitydigital.services/rdap/domain/{}.coach', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.codes', url: 'https://rdap.identitydigital.services/rdap/domain/{}.codes', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.coffee', url: 'https://rdap.identitydigital.services/rdap/domain/{}.coffee', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.com.au', url: 'https://rdap.cctld.au/rdap/domain/{}.com.au', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.com.br', url: 'https://rdap.registro.br/domain/{}.com.br', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.community', url: 'https://rdap.identitydigital.services/rdap/domain/{}.community', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.consulting', url: 'https://rdap.identitydigital.services/rdap/domain/{}.consulting', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.cool', url: 'https://rdap.identitydigital.services/rdap/domain/{}.cool', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.cx', url: 'https://rdap.nic.cx/domain/{}.cx', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.cz', url: 'https://rdap.nic.cz/domain/{}.cz', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.deals', url: 'https://rdap.identitydigital.services/rdap/domain/{}.deals', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.doctor', url: 'https://rdap.identitydigital.services/rdap/domain/{}.doctor', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.earth', url: 'https://rdap.nic.earth/domain/{}.earth', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.eco', url: 'https://rdap.eco.fury.ca/rdap/domain/{}.eco', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.engineering', url: 'https://rdap.identitydigital.services/rdap/domain/{}.engineering', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.fan', url: 'https://rdap.identitydigital.services/rdap/domain/{}.fan', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.fans', url: 'https://rdap.centralnic.com/fans/domain/{}.fans', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.fashion', url: 'https://rdap.nic.fashion/domain/{}.fashion', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.film', url: 'https://rdap.nic.film/domain/{}.film', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.fitness', url: 'https://rdap.identitydigital.services/rdap/domain/{}.fitness', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.fyi', url: 'https://rdap.identitydigital.services/rdap/domain/{}.fyi', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.gallery', url: 'https://rdap.identitydigital.services/rdap/domain/{}.gallery', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.green', url: 'https://rdap.identitydigital.services/rdap/domain/{}.green', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.group', url: 'https://rdap.identitydigital.services/rdap/domain/{}.group', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.health', url: 'https://rdap.nic.health/domain/{}.health', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.icu', url: 'https://rdap.centralnic.com/icu/domain/{}.icu', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.is', url: 'https://rdap.isnic.is/rdap/domain/{}.is', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.law', url: 'https://rdap.nic.law/domain/{}.law', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.legal', url: 'https://rdap.identitydigital.services/rdap/domain/{}.legal', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.love', url: 'https://rdap.registry.love/rdap/domain/{}.love', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.ly', url: 'https://rdap.nic.ly/domain/{}.ly', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.market', url: 'https://rdap.identitydigital.services/rdap/domain/{}.market', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.news', url: 'https://rdap.identitydigital.services/rdap/domain/{}.news', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.photography', url: 'https://rdap.identitydigital.services/rdap/domain/{}.photography', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.pictures', url: 'https://rdap.identitydigital.services/rdap/domain/{}.pictures', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.pizza', url: 'https://rdap.identitydigital.services/rdap/domain/{}.pizza', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.press', url: 'https://rdap.radix.host/rdap/domain/{}.press', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.re', url: 'https://rdap.nic.re/domain/{}.re', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.rocks', url: 'https://rdap.identitydigital.services/rdap/domain/{}.rocks', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.sale', url: 'https://rdap.identitydigital.services/rdap/domain/{}.sale', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.science', url: 'https://rdap.nic.science/domain/{}.science', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.services', url: 'https://rdap.identitydigital.services/rdap/domain/{}.services', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.sg', url: 'https://rdap.sgnic.sg/rdap/domain/{}.sg', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.software', url: 'https://rdap.identitydigital.services/rdap/domain/{}.software', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.style', url: 'https://rdap.identitydigital.services/rdap/domain/{}.style', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.support', url: 'https://rdap.identitydigital.services/rdap/domain/{}.support', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.th', url: 'https://rdap.thains.co.th/domain/{}.th', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.top', url: 'https://rdap.zdnsgtld.com/top/domain/{}.top', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.ua', url: 'https://rdap.hostmaster.ua/domain/{}.ua', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.video', url: 'https://rdap.identitydigital.services/rdap/domain/{}.video', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.vip', url: 'https://rdap.nic.vip/domain/{}.vip', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.wiki', url: 'https://rdap.nic.wiki/domain/{}.wiki', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'google', testAvailableNick: 'qvxzmklwrt8842' },
  { name: '.wtf', url: 'https://rdap.identitydigital.services/rdap/domain/{}.wtf', category: 'Domain Names', checkMethod: CheckMethod.Rdap, testTakenNick: 'nic', testAvailableNick: 'qvxzmklwrt8842' },
  ...
  { name: 'InsaneJournal', url: 'https://{}.insanejournal.com/profile', category: 'Content & Blogging', checkMethod: CheckMethod.Unverifiable, unverifiableReason: UnverifiableReason.BotProtected, testTakenNick: 'alex', testAvailableNick: 'zqvx8841mkw' },
  ...
  { name: 'DOTAFire', url: 'https://www.dotafire.com/ajax/searchSite?text={}&search=members', category: 'Consoles & Esports', checkMethod: CheckMethod.Unverifiable, unverifiableReason: UnverifiableReason.RateLimited, testTakenNick: 'DotaCoachApp', testAvailableNick: 'zqvx8841mkw' },
  ...
  { name: 'RubyGems Gem', url: 'https://rubygems.org/gems/{}', apiUrl: 'https://rubygems.org/api/v1/gems/{}.json', category: 'Package Names', checkMethod: CheckMethod.Standard, testTakenNick: 'rails', testAvailableNick: 'zqvx8841mkw-nothing' },
  { name: 'NuGet', url: 'https://www.nuget.org/packages/{}', apiUrl: 'https://api.nuget.org/v3-flatcontainer/{}/index.json', category: 'Package Names', checkMethod: CheckMethod.Standard, testTakenNick: 'newtonsoft.json', testAvailableNick: 'zqvx8841mkw-nothing' },
  { name: 'Hex', url: 'https://hex.pm/packages/{}', apiUrl: 'https://hex.pm/api/packages/{}', category: 'Package Names', checkMethod: CheckMethod.Standard, testTakenNick: 'phoenix', testAvailableNick: 'zqvx8841mkw-nothing' },
  { name: 'Homebrew Formula', url: 'https://formulae.brew.sh/formula/{}', apiUrl: 'https://formulae.brew.sh/api/formula/{}.json', category: 'Package Names', checkMethod: CheckMethod.Standard, testTakenNick: 'wget', testAvailableNick: 'zqvx8841mkw-nothing' },
  { name: 'CocoaPods', url: 'https://cocoapods.org/pods/{}', apiUrl: 'https://trunk.cocoapods.org/api/v1/pods/{}', category: 'Package Names', checkMethod: CheckMethod.Standard, testTakenNick: 'Alamofire', testAvailableNick: 'zqvx8841mkw-nothing' },
  { name: 'Pub.dev', url: 'https://pub.dev/packages/{}', apiUrl: 'https://pub.dev/api/packages/{}', category: 'Package Names', checkMethod: CheckMethod.Standard, testTakenNick: 'http', testAvailableNick: 'zqvx8841mkw-nothing' },
  { name: 'Chocolatey Package', url: 'https://community.chocolatey.org/packages/{}', category: 'Package Names', checkMethod: CheckMethod.Standard, testTakenNick: 'git', testAvailableNick: 'zqvx8841mkw-nothing' },
];
