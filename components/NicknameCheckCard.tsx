...
export const NicknameCheckCard = ({ nickname, service, className }: Props) => {
  ...
  const statusClass = () => {
    ...
    if (data && data === AVAILABILITY_RESPONSE.AVAILABLE) return 'text-green-500';

    return 'text-red-500';
  }

  return (
    <div className={cx('flex flex-col border rounded-xl px-4 p-2 md:p-4', className)}>
